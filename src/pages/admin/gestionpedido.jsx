...
export default function GestionPedido() {
    ...
    const unsubscribe = onValue(
      ...
      (snapshot) => {
        if (snapshot.exists()) {
          ...
          console.log(
            `Recibidos ${Object.keys(pedidosData).length} pedidos de Firebase`
          );

          // Agregar este log para depuración
          console.log(
            "Muestra de datos de pedido:",
            Object.values(pedidosData)[0]
          );
          if (Object.values(pedidosData)[0]?.carrito) {
            console.log(
              "Muestra de carrito:",
              Object.values(Object.values(pedidosData)[0].carrito)[0]
            );
            console.log(
              "Tipo de precio:",
              typeof Object.values(Object.values(pedidosData)[0].carrito)[0]
                .precio
            );
          }
  ...
  const cargarInfoClientes = async (pedidosArray) => {
    ...
    const clientesUnicos = [
      ...new Set(
        pedidosArray.map((pedido) => pedido.clientUid).filter(Boolean)
      ),
    ];
    console.log(
      `Cargando información para ${clientesUnicos.length} clientes únicos`
    );
          ...
          try {
            ...
            if (snapshot.exists()) {
              ...
              nuevoCache[clienteId] = {
                id: clienteId,
                nombre:
                  clienteData.displayName || clienteData.email || "Cliente",
          ...
          <div className="card p-4 shadow-sm rounded-4 mb-4">
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
              ...
              <div className="d-flex flex-wrap gap-2">
                {["todos", "pendiente", "realizado", "cancelado"].map(
                  (estado) => (
                    <button
                      key={estado}
                      className={`btn ${
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              ...
                              >
                                <img
                                  src={
                                    pedido.cliente?.avatar || "/placeholder.svg"
                                  }
                        ...
                        <div className="card bg-light border-0 p-3 h-100">
                          ...
                          <div className="d-flex align-items-center mb-2">
                            ...
                            >
                              <img
                                src={
                                  pedidoSeleccionado.cliente?.avatar ||
                                  "/placeholder.svg"
                                }
